	...
	<form name="writeForm" action="writeProcess" id="writeForm" class="border-primary offset-2" method="post"
		...
		<div class="row">
			...
			<div class="col-3">
				...
				<input type="number" class="form-control" name="km" id="km" placeholder="km 를 입력해주세요">
			</div>
		</div>
		<div class="row">
			<div class="col offset-4 " id="replyTitle">
				<input type="button" class="btn btn-secondary" value="상세 등록하기" />
			</div>
		</div>
		<div class="row">
			<div class="col">
					...
					<div class="col">
						<div class="row">
							<div class="col-4">
								...
								<input type="text" class="form-control" name="wiper" id="wiper"
									placeholder="">
							</div>
							<div class="col-4">
								<label for="coolan" class="form-label my-0">냉각수</label>
								<input type="text" class="form-control" name="coolan" id="coolan"
									placeholder="">
							</div>
							<div class="row">
								<div class="col-4">
								...
								<div class="col-4">
									...
									<input type="text" class="form-control" name="aircon" id="aircon"
										placeholder="">
								</div>
							</div>
							<div class="row">
								<div class="col-4">
									...
									<input type="text" class="form-control" name="tire" id="tire"
										placeholder="">
								</div>
								<div class="col-4">
