...
<div class="row my-5" id="global-content">
	<c:choose>
		<c:when test="${overlap}">
	<!-- 아이디가 중복 되는 경우 - 아이디를 사용할 수 없는 경우 -->
			<div class="col">
			<!-- title -->
				<div class="row">
					<div class="col">	
				<h2 class="fs-3 fw-bold text-center"> 사용 할 수 없는 아이디 </h2>
					</div>
				</div>
				<div class="row my-3">
	...
	<c:otherwise>
	<!-- 아이디가 중복 되지 않는 경우 - 아이디를 사용할 수 있는 경우 -->
			<div class="col">
				<div class="row">
					<div class="col">	
				<h2 class="fs-3 fw-bold text-center"> 사용 할 수 있는 아이디 </h2>
					</div>
				</div>
				<div class="row my-3">
					<div class="col text-center">
				...
				<div class="row mt-5">
					<div class="col text-center">
						...
						id="btnIdCheckClose" class="btn btn-primary"
						data-id-value="${id}">
					</div>
				</div>
			</div>
